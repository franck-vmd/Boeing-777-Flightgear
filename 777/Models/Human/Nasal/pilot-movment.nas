...
#var pilot_theme_dialog = gui.OverlaySelector.new("Select Theme", "Aircraft/777/Models/Human/Models/Themes", "sim/model/crew/" ~ num ~ "/theme-name", nil, "sim/multiplay/generic/string[11]");
