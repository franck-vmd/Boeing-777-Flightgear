    ...
    var walker_model = {
       ...
       add:   func {
             ...
             var manager = props.globals.getNode("/models", 1);
                ...
                setprop ("models/model[" ~ i ~ "]/path", "Aircraft/777/Models/Human/Models/walker.xml");
...
var theme_dialog = gui.OverlaySelector.new("Select Theme", "Aircraft/777/Models/Human/Models/Themes", "sim/walker/theme-name", nil, "sim/multiplay/generic/string[10]");
var equip_dialog = gui.OverlaySelector.new("Select Equipment", "Aircraft/777/Models/Human/Models/equipment/Themes", "sim/walker/equipment-name", nil, "sim/multiplay/generic/string[11]");
