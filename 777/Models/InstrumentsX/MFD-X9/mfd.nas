...
var mfdReload= func() {
    ...
    mfdDel();
    io.load_nasal(getprop("/sim/fg-root") ~ "/Aircraft/777/Models/Instruments/MFD-X9/mfd.nas","b777");
    io.load_nasal(getprop("/sim/fg-root") ~ "/Aircraft/777/Models/Instruments/MFD-X9/fuel.nas","b777");
    mfdCreate();
}
