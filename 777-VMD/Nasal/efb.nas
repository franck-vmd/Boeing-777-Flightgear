    ...
    update : func {
        ...
        #__________________________________________________________________________________________|
                ...
                if (keypress == "l3") { 
                    ...
                    setProp("sim/model/efb/page", "Displays/CDU_1.jpg");
                    setProp("instrumentation/efb/page", "CDU");
                    keypress = "";
                }
                elsif (keypress == "r4") { 
        ...
        #__________________________________________________________________________________________|
            ...
            if (keypress == "l1") { 
                setProp("sim/model/efb/page", "Displays/CDU_2.jpg");
                setProp("instrumentation/efb/page", "CDU");
                keypress = "";
            }
            if (keypress == "l2") { 
                setProp("sim/model/efb/page", "Displays/CDU_3.jpg");
                setProp("instrumentation/efb/page", "CDU");
                keypress = "";
            }
            if (keypress == "l3") { 
                setProp("sim/model/efb/page", "Displays/CDU_4.jpg");
                setProp("instrumentation/efb/page", "CDU");
                keypress = "";
            }
            if (keypress == "l4") { 
                setProp("sim/model/efb/page", "Displays/CDU_5.jpg");
                setProp("instrumentation/efb/page", "CDU");
                keypress = "";
            }
            if (keypress == "l5") { 
                setProp("sim/model/efb/page", "Displays/CDU_6.jpg");
                setProp("instrumentation/efb/page", "CDU");
                keypress = "";
            }
            if (keypress == "l6") { 
                setProp("sim/model/efb/page", "Displays/CDU_7.jpg");
                setProp("instrumentation/efb/page", "CDU");
                keypress = "";
            }
            if (keypress == "l7") { 
                setProp("sim/model/efb/page", "Displays/CDU_8.jpg");
                setProp("instrumentation/efb/page", "CDU");
                keypress = "";
            }
            if (keypress == "l8") { 
                setProp("sim/model/efb/page", "Displays/CDU_9.jpg");
                setProp("instrumentation/efb/page", "CDU");
                keypress = "";
            }
            #__________________________________________________________________________________________
