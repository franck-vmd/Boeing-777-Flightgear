# A Cabin Pressure System for the 777, by Franck VMD DEC 2023
...
var valve_switch0 = props.globals.initNode("controls/pressurization/valve-switch[0]",0,"INT");
var valve_switch1 = props.globals.initNode("controls/pressurization/valve-switch[1]",0,"INT");
...
var update_mode = func {
	...
	if (mode.getValue() == 1) {
	    ...
	    var alt_setting = getprop("autopilot/settings/actual-target-altitude-ft");
