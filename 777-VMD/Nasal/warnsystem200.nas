...
## so the advisory section below is not quite accurate
    ...
    # POIDS takeoff
	if ((getprop("yasim/gross-weight-lbs") > 545000) and (getprop("position/gear-agl-ft") < 500))
	{
	    append(me.msgs_caution,">EXCEED GROSS WEIGHT");
	}

    # POIDS landing
	if ((getprop("yasim/gross-weight-lbs") > 445000) and (getprop("position/gear-agl-ft") > 2500) and (getprop("position/gear-agl-ft") < 6000))
	{
