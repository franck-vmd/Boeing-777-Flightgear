...
var mfdReload= func() {
    ...
    mfdDel();
    io.load_nasal(getprop("/sim/fg-root") ~ "/Aircraft/777-VMD/Models/InstrumentsX/MFD-X8F/mfd.nas","b777");
    io.load_nasal(getprop("/sim/fg-root") ~ "/Aircraft/777-VMD/Models/InstrumentsX/MFD-X8F/fuel.nas","b777");
    mfdCreate();
}
